...
<답변>
위 <정보>에서 질문과 관련된 내용만 찾아서 정확하게 답변하세요. 
- 각 정보에는 "기간", "날짜", "제목", "내용"이 포함되어 있습니다.
- 날짜나 기간이 있는 경우 정확한 날짜를 포함하여 답변하세요.
- 분할납부의 경우 1차, 2차, 3차를 구분하여 답변하세요.
- 정보에 정확한 답이 없으면 "제공된 정보에서 해당 내용을 찾을 수 없습니다."라고 답변하세요.\n"""
        return prompt
